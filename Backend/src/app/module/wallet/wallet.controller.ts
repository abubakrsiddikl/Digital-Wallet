...
const getWalletByUserId = catchAsync(async (req: Request, res: Response) => {
  const result = await WalletServices.getWalletByUserId(
...
const getSystemWallet = catchAsync(async (req: Request, res: Response) => {
...
const toggleBlockWallet = catchAsync(async (req: Request, res: Response) => {
  const result = await WalletServices.toggleBlockWallet(
    req.params.userId as string,
  );
