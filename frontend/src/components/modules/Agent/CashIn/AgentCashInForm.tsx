...
import { cashInAgentToUser } from "@/services/transaction/transaction.api";
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-start gap-2.5 rounded-xl bg-emerald-50 dark:bg-emerald-950/30 border border-emerald-200 dark:border-emerald-800 px-4 py-3">
            ...
            <p className="text-xs text-emerald-700 dark:text-emerald-300 leading-relaxed">
              Enter the user&apos;s phone number. You hand over the cash — their
              wallet balance will increase.
            </p>
          </div>
          ...
          <Field>
            ...
            <div className="relative">
              ...
              <Input
                ...
                name="userPhone"
                type="tel"
                placeholder="User's 01XXXXXXXXX"
                className="pl-10"
                maxLength={11}
              />
            </div>
            ...
            <Card className="bg-muted/40 border-dashed">
              <CardContent className="p-4 space-y-2 text-sm">
                ...
                <div className="flex justify-between text-muted-foreground">
                  ...
                  <span className="text-purple-600 dark:text-purple-400 tabular-nums font-medium">
