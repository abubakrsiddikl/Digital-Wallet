...
// import { BanknoteIcon, FileText, Info, BadgeDollarSign } from "lucide-react";
...
//     if (state.success) {
//       toast.success(state.message ?? "Balance request submitted!");
//       setAmount("");
//       setNote("");
//     }
//   }, [state]);
...
//               Admin will review your request and approve or reject it. You will be notified once processed.
//             </p>
//           </div>
...
//                   <span className="text-blue-600 dark:text-blue-400 tabular-nums">৳ {numericAmount.toLocaleString()}</span>
//                 </div>
//                 <p className="text-xs text-muted-foreground mt-1.5">
//                   Admin approval required before balance is credited to your wallet.
//                 </p>
//               </CardContent>
//             </Card>
//           )}
