    ...
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-2">
          ...
          <Button variant="outline" size="sm" className="rounded-xl h-9 px-4 text-sm">
            Login
          </Button>
          <Button
            size="sm"
      ...
      {menuOpen && (
        <div className="md:hidden border-t border-border/50 bg-background/95 backdrop-blur-md px-4 py-4 flex flex-col gap-1">
          ...
          <div className="flex flex-col gap-2">
            <Button variant="outline" className="rounded-xl justify-center">Login</Button>
  ...
  const features = [
    {
      icon: <Icons.Send />,
      title: "Send Money",
      desc: "Transfer money instantly to any Takaa user using just their phone number. Zero delay, zero hassle.",
      badge: "Instant",
    },
    {
      icon: <Icons.Activity />,
      title: "Cash In / Cash Out",
      desc: "Deposit or withdraw cash through thousands of agents nationwide. Available 24/7.",
      badge: "500+ Agents",
    },
    {
      icon: <Icons.Shield />,
      title: "Secure Transactions",
      desc: "Every transaction is protected by your personal PIN and 256-bit AES encryption.",
      badge: "Bank-grade",
    },
    {
      icon: <Icons.Zap />,
      title: "Real-time Balance",
      desc: "See your wallet balance update the moment a transaction completes. Always accurate.",
      badge: "Live",
    },
  ];
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="mt-3 text-muted-foreground max-w-xl mx-auto">
            Simple, powerful tools designed for everyday banking — without the bank.
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {features.map((f, i) => (
            <Card
              key={i}
              className="rounded-2xl border border-border hover:border-emerald-200 dark:hover:border-emerald-800 hover:shadow-md transition-all duration-200 group"
            >
              <CardContent className="p-5 flex flex-col gap-4">
                <div className="flex items-start justify-between">
                  <div className="w-10 h-10 rounded-xl bg-emerald-50 dark:bg-emerald-900/40 text-emerald-600 dark:text-emerald-400 flex items-center justify-center group-hover:scale-110 transition-transform duration-200">
                    {f.icon}
                  </div>
                  <Badge
                    variant="secondary"
                    className="text-[10px] px-2 py-0.5 rounded-full bg-emerald-50 text-emerald-700 dark:bg-emerald-900/40 dark:text-emerald-400 border-0"
                  >
                    {f.badge}
                  </Badge>
                </div>
...
function SecuritySection() {
  const points = [
    { title: "PIN Protection", desc: "Every sensitive transaction requires your personal 5-digit PIN." },
    { title: "End-to-end Encryption", desc: "All data in transit is protected with 256-bit AES encryption." },
    { title: "Instant Block", desc: "Suspect fraud? Block your wallet instantly from the app." },
    { title: "Audit Logs", desc: "Every transaction is logged and traceable for full transparency." },
  ];
      ...
      <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <p className="text-muted-foreground mb-8 leading-relaxed">
            We use the same level of security as Bangladesh&apos;s leading banks. Every
            transaction is monitored, every account is protected.
          </p>
          <div className="flex flex-col gap-4">
            {points.map((p, i) => (
              <div key={i} className="flex gap-3">
                <span className="mt-0.5 flex-shrink-0 w-5 h-5 rounded-full bg-emerald-100 dark:bg-emerald-900/40 text-emerald-700 dark:text-emerald-400 flex items-center justify-center">
                  <Icons.Check />
                </span>
                <div>
        ...
        <div className="flex justify-center">
          <div className="relative w-64 h-64">
            <div className="absolute inset-0 rounded-full bg-emerald-100 dark:bg-emerald-900/20 animate-pulse" />
            <div className="absolute inset-6 rounded-full bg-emerald-200 dark:bg-emerald-900/40" />
            <div className="absolute inset-12 rounded-full bg-emerald-500 flex items-center justify-center">
...
function Footer() {
  ...
  return (
    <footer className="border-t border-border bg-muted/20 px-4 sm:px-6 pt-12 pb-8">
      <div className="max-w-6xl mx-auto">
        <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-8 mb-10">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-2.5 mb-3">
              <Icons.Logo />
              <span className="text-lg font-bold text-foreground">Takaa</span>
            </div>
            <p className="text-sm text-muted-foreground leading-relaxed max-w-xs">
              Bangladesh&apos;s trusted digital wallet. Send, receive, and manage
              money with confidence.
            </p>
            <div className="flex gap-3 mt-4">
              {[Icons.Twitter, Icons.Github, Icons.Linkedin].map((Icon, i) => (
                <button
                  key={i}
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-2">
          <p className="text-xs text-muted-foreground">
            © 2026 Takaa. All rights reserved.
          </p>
          <p className="text-xs text-muted-foreground">
